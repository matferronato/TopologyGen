...
public class optServer_controller : MonoBehaviour
{
    ...
    public List<string> getAvaiableCheckBoxOptions()
    {
        ...
        {
            path_standart = @"../../Automate/vagrant_box/server_services.txt";
    ...
    public void giveNewName()
    {
        ...
        {
            thisServer.name = "Server-" + thisText;
    ...
    public void giveOSOption()
    {
        ...
        thisServer.GetComponent<drag_and_drop>().OSversion = OSversionOptionsList[thisDropdown.value];
    }
